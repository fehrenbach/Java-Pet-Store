...
$Id: scroller.js,v 1.4 2006-03-02 07:06:49 gmurray71 Exp $
*/
...
function ImageScroller() {
    ...
    // public event that starts a right scroll 
    this.getNext = function() {
        isScrollingRight = true;
        setTimeout(scroll, timeout);
    }
    
    // public event that starts a left scroll
    ...
    function createTile(i) {
        ...
        if (isIE) {
            div.attachEvent('onclick',function(e){showImage(e.srcElement.getAttribute("id"));});
        } else {
            div.addEventListener('click',function(e){showImage(e.currentTarget.getAttribute("id"));}, true);
        }
